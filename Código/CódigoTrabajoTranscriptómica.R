...
## ----boxplotsBaseAll, fig.width=12, fig.height=4--------------------------------------------------------------------------------------------------------
...
## ----histIntensitiesAll, fig.width=12, fig.height=4.2---------------------------------------------------------------------------------------------------
...
## ----MAplotALL1, fig.width=12, fig.height=4.2-----------------------------------------------------------------------------------------------------------
...
## ----MAplotALL2, fig.width=12, fig.height=4.2-----------------------------------------------------------------------------------------------------------
par(mfrow = c(1, 2), mar = c(4.1, 4.1, 2.1, 1.8), mgp=c(2.1, 1, 0))
...
## ----pcaAllLines, fig.width=12, fig.height=4.2----------------------------------------------------------------------------------------------------------
...
## ----matrixDistanceHeatmapAll, fig.width=8--------------------------------------------------------------------------------------------------------------
...
## ----boxplotsBaseKOPTK1, fig.width=12, fig.height=4-----------------------------------------------------------------------------------------------------
par(mfrow = c(1, 2), mar = c(5.1, 4.1, 1.4, 1.4), mgp=c(2.1, 1, 0))
...
## ----histIntensitiesKOPTK1, fig.width=12, fig.height=4.2------------------------------------------------------------------------------------------------
par(mfrow = c(1, 2), mar = c(4.1, 4.1, 1.4, 1.8), mgp=c(2.1, 1, 0))
...
## ----MAplotKOPT1, fig.width=12, fig.height=4.2----------------------------------------------------------------------------------------------------------
par(mfrow = c(1, 2), mar = c(4.1, 4.1, 2.1, 1.8), mgp = c(2.1, 1, 0))
...
## ----MAplotKOPT2, fig.width=12, fig.height=4.2----------------------------------------------------------------------------------------------------------
par(mfrow = c(1, 2), mar = c(4.1, 4.1, 2.1, 1.8), mgp = c(2.1, 1, 0))
...
## ----pcaKOPT-K1, fig.width=12, fig.height=4.2-----------------------------------------------------------------------------------------------------------
...
## ----boxplotsBaseHPBALL, fig.width=12, fig.height=4-----------------------------------------------------------------------------------------------------
par(mfrow = c(1, 2), mar = c(5.1, 4.1, 1.4, 1.4), mgp=c(2.1, 1, 0))
...
## ----histIntensitiesHPBALL, fig.width=12, fig.height=4.2------------------------------------------------------------------------------------------------
par(mfrow = c(1, 2), mar = c(4.1, 4.1, 1.4, 1.8), mgp=c(2.1, 1, 0))
...
## ----MAplotHPBALL1, fig.width=12, fig.height=4.2--------------------------------------------------------------------------------------------------------
par(mfrow = c(1, 2), mar = c(4.1, 4.1, 2.1, 1.8), mgp = c(2.1, 1, 0))
...
## ----MAplotHPBALL2, fig.width=12, fig.height=4.2--------------------------------------------------------------------------------------------------------
par(mfrow = c(1, 2), mar = c(4.1, 4.1, 2.1, 1.8), mgp = c(2.1, 1, 0))
...
## ----pcaHPBALL, fig.width=12, fig.height=4.2------------------------------------------------------------------------------------------------------------
...
## ----annotateMatrixHPALL, warning=FALSE, message=FALSE--------------------------------------------------------------------------------------------------
...
## ----volcanoPlots, fig.width=12, fig.height=4.2---------------------------------------------------------------------------------------------------------
par(mfrow = c(1, 2), mar = c(4.1, 4.1, 2.1, 1.8), mgp = c(2.1, 1, 0))
...
## ----vennDiagram, fig.width=12, fig.height=4.2----------------------------------------------------------------------------------------------------------
...
## ----testViolinPlotsHES1, fig.width=12, fig.height=7----------------------------------------------------------------------------------------------------
## KOPT-K1
...
## ----testViolinPlotsHES4, fig.width=12, fig.height=4----------------------------------------------------------------------------------------------------
## KOPT-K1
...
## ----testViolinPlotsMYC, fig.width=12, fig.height=4-----------------------------------------------------------------------------------------------------
## KOPT-K1
...
## ----testViolinPlotsDTX1, fig.width=12, fig.height=4----------------------------------------------------------------------------------------------------
## KOPT-K1
...
## ----boxplotsBaseAllMean, fig.width=12, fig.height=4----------------------------------------------------------------------------------------------------
par(mfrow = c(1, 2), mar = c(5.1, 4.1, 1.4, 1.4), mgp=c(2.1, 1, 0))
...
## ----histIntensitiesAllMean, fig.width=12, fig.height=4.2-----------------------------------------------------------------------------------------------
par(mfrow = c(1, 2), mar = c(4.1, 4.1, 1.4, 1.8), mgp=c(2.1, 1, 0))
hist(rawDataAffy, lty = rep(1, nrow(dfTargets)),
     col = cols$colorPoints[as.factor(dfTargets$CellLine)],
     xlab = "Intensity", ylab = "Density", cex.main = 0.99,
